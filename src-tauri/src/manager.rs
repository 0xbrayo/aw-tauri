...
//     // Set up PR_SET_PDEATHSIG to receive SIGTERM when parent dies
//     // Note: This monitors the thread that spawned us, not the entire process
//     unsafe {
//         if libc::prctl(libc::PR_SET_PDEATHSIG, Signal::SIGTERM as libc::c_int) != 0 {
//             error!("Failed to set PR_SET_PDEATHSIG");
//         } else {
//             debug!("Set PR_SET_PDEATHSIG to SIGTERM");
//         }
//     }
// }
